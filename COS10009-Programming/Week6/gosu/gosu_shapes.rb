...
class DemoWindow < Gosu::Window
  ...
  def draw
    ...
    draw_quad(
      5, 10, Gosu::Color::BLUE,
      200, 10, Gosu::Color::AQUA,
      5, 150, Gosu::Color::FUCHSIA,
      200, 150, Gosu::Color::RED,
      ZOrder::MIDDLE
    )
    draw_triangle(
      50, 50, Gosu::Color::GREEN,
      100, 50, Gosu::Color::GREEN,
      50, 100, Gosu::Color::GREEN,
      ZOrder::MIDDLE, mode = :default
    )
    draw_line(
      200, 200, Gosu::Color::BLACK,
      350, 350, Gosu::Color::BLACK,
