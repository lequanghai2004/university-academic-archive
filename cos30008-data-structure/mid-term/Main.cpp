...
int runP2(string argv[2])
{
    ...
    cout << "Encoding \"" << lMessage << "\" using \""
         << lSrambler.getCurrentKeyword() << "\"" << endl;
    ...
    cout << "Decoding \"" << lEncodedMessage << "\" using \""
         << lSrambler.getCurrentKeyword() << "\"" << endl;
...
int runP3(string argv[2])
{
    ...
    cout << "Decoding \"" << argv[1] << "\" using \"" << argv[0] << "\"."
         << endl;
...
#ifdef P1
    string lArgv1[]
        = {"Relations", "To be, or not to be: that is the question:"};
